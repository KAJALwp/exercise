...
class Opry {
	...
	protected function setup_hooks() {
		...
		add_action( 'admin_bar_menu', array( $this, 'add_theme_setting_admin_bar_link' ), 100 );
	}
	...
	/**
	 * Display opry theme setting link.
	 *
	 * @param string[] $admin_bar admin bar object.
	 *
	 * @since 1.0.0
	 */
	public function add_theme_setting_admin_bar_link( $admin_bar ) {
		...
		$admin_bar->add_menu(
			array(
				'parent' => $menu_id,
				'title'  => __( 'Opry Settings', 'opry' ),
				'id'     => 'opry-settings',
				'href'   => admin_url( 'admin.php?page=opry-settings' ),
			)
		);
	}
}
