...
$template_tags_class = \OPRY\Includes\Template_Tags::get_instance();
?>

<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="opry-post-article u-margin-t50 u-margin-b50 u-margin-t50@max-767 u-margin-b50@max-767 u-bg-white u-padding-a15">
			...
			the_content(
				sprintf(
					wp_kses(
						...
						__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'opry' ),
						array(
							'span' => array(
								'class' => array(),
							),
